...
// --- Mock DEMO để fallback khi API lỗi ---
...
// --- Bảng mốc PM2.5 theo US-EPA (µg/m³) ---
...
// --- O3 (Open-Meteo trả µg/m³) – mapping xấp xỉ để fallback ---
...
// (tuỳ chọn) thêm default export để tránh nhầm lẫn import
